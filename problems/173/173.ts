...
tree1.print()
console.log(it1.next())    // Expected: 3
console.log(it1.hasNext()) // Expected: true
console.log(it1.next())    // Expected: 7
console.log(it1.hasNext()) // Expected: true
console.log(it1.next())    // Expected: 9
console.log(it1.hasNext()) // Expected: true
console.log(it1.next())    // Expected: 15
console.log(it1.hasNext()) // Expected: true
console.log(it1.next())    // Expected: 20
console.log(it1.hasNext()) // Expected: false

// Test 2: single node
const tree2 = new BinaryTree([42])
const it2 = new BSTIterator(tree2.root)
console.log(it2.hasNext()) // Expected: true
console.log(it2.next())    // Expected: 42
console.log(it2.hasNext()) // Expected: false
...
console.log(it3.next())    // Expected: 1
console.log(it3.hasNext()) // Expected: true
console.log(it3.next())    // Expected: 2
console.log(it3.hasNext()) // Expected: true
console.log(it3.next())    // Expected: 3
console.log(it3.hasNext()) // Expected: false
