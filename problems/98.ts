...
console.log(isValidBST(new BinaryTree([2, 1, 3]).root))
console.log(isValidBST(new BinaryTree([5, 1, 4, null, null, 3, 6]).root))
console.log(isValidBST(new BinaryTree([0]).root))

new BinaryTree([2, 1, null, 1, null, null, null]).print()
console.log(isValidBST(new BinaryTree([2, 1, null, 1, null, null, null]).root))

console.log(isValidBST(new BinaryTree([5, 14, null, 1]).root))

// new BinaryTree([5, 4, 6, null, null, 3, 7]).print()
console.log(isValidBST(new BinaryTree([5, 4, 6, null, null, 3, 7]).root))
