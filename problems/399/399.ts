...
console.log(calcEquation([['a', 'b'], ['b', 'c'], ['bc', 'cd']], [1.5, 2.5, 5.0], [['a', 'c'], ['c', 'b'], ['bc', 'cd'], ['cd', 'bc']])) // [ 3.75, 0.4, 5, 0.2 ]
console.log(calcEquation([['a', 'b']], [0.5], [['a', 'b'], ['b', 'a'], ['a', 'c'], ['x', 'y']])) // [ 0.5, 2, -1, -1 ]
console.log(calcEquation([['a', 'b'], ['c', 'd']], [1.0, 1.0], [['a', 'c'], ['b', 'd'], ['b', 'a'], ['d', 'c']])) // [ -1, -1, 1, 1 ]
