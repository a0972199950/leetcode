...
//     const product = BigInt(prefixProducts.at(-1) ?? 1) * BigInt(num)
...
//       const product = prefixProducts[j] / (prefixProducts[i - 1] ?? BigInt(1))
//       if (product < k) {
//         result++
//       }
