...
console.log(possibleBipartition(4, [[1, 2], [1, 3], [2, 4]])) // true // Expected: true
console.log(possibleBipartition(3, [[1, 2], [1, 3], [2, 3]])) // false // Expected: false
console.log(possibleBipartition(7, [[1, 2], [3, 4], [1, 7], [4, 2], [5, 6]])) // true // Expected: true
console.log(possibleBipartition(1, [])) // true // Expected: true
console.log(possibleBipartition(2, [])) // true // Expected: true
console.log(possibleBipartition(5, [[1, 2], [3, 4], [4, 5], [3, 5]])) // false // Expected: false
