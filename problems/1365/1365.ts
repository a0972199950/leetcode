...
console.log(smallerNumbersThanCurrent([8, 1, 2, 2, 3])) // Expected: [ 4, 0, 1, 1, 3 ]
console.log(smallerNumbersThanCurrent([6, 5, 4, 8])) // Expected: [ 2, 1, 0, 3 ]
console.log(smallerNumbersThanCurrent([7, 7, 7, 7])) // Expected: [ 0, 0, 0, 0 ]
