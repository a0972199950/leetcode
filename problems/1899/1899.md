...
- **難度**：Medium
- **連結**：https://leetcode.com/problems/merge-triplets-to-form-target-triplet/
- **標籤**：Array, Greedy
...
Return `true` _if it is possible to obtain the_ `target` _**triplet**_ `[x, y, z]` _as an **element** of_ `triplets`, or `false` _otherwise_.
